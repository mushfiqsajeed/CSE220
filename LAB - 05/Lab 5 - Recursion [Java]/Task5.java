public class Task5 {
    ...
    public static void findDup_Recursive(Node head) {
        // TODO: Implement this recursively
        helper1_Recursive(head);
    }

    //Helper Methods
    public static void helper1_Recursive(Node head) 
    {
        Node curr = head;
        ...
        while (curr != null)
        {
            ...
            helper2_Recursive(head, curr);

            curr = curr.next;
        }
    }
    
    public static void helper2_Recursive(Node head, Node x)
    {
        Node current = head;
        int indx = 0;
        boolean check = false;
        ...
        while (current != null)
        {
            if ((x.elem == current.elem) && current != x)
            {
                check = true;
