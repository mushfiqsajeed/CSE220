...
public class HashTable {
    ...
    public String searchHashtable( Object[] keyValuePair ){
        ...
        int indx = hashFunction((String) keyValuePair[0]);
        PairNode current = ht[indx];

        if (current == null) return "Not Found";

        while (current != null)
        {
            if (current.key.equals(keyValuePair[0]))
            {
                return "Found";
            }
